...
for reps in range(100):
    with open("../res_folder/simu2-1/res_" + str(reps + 1) + ".pkl", "rb") as f:
        (
            responses_all,
            S_ij_all1,
            S_i_obs,
...
plot_analysis_point_estimation(
    ...
    estimated_mean,
    "../res_folder/simu2-1/analysis" + str(analysis_index) + "_point.png",
)
...
plot_analysis_boxplot(
    difference,
    "../res_folder/simu2-1/analysis" + str(analysis_index) + "_boxplot.png",
...
plot_analysis_sd_estimation(
    empirical_sd,
    estimated_sd,
    "../res_folder/simu2-1/analysis" + str(analysis_index) + "_sd.png",
)
...
plot_analysis_coverage(
    coverage_ratios,
    "../res_folder/simu2-1/analysis" + str(analysis_index) + "_cover.png",
